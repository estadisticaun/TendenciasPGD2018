...
Presentar a la comunidad universitaria y  a la sociedad en general las tendencias y el comportamiento actual de un número importante de estadísticas e indicadores institucionales de la [Universidad Nacional de Colombia](http://unal.edu.co/). Esperamos que la disposición y el análisis de esta información y de otras fuentes disponibles, alimenten el debate en los diferentes espacios de construcción colectiva  que acompañarán los procesos de construcción del [Plan Global de Desarrollo 2019-2021](http://plei2030.unal.edu.co/) y del [Plan Estratégico Institucional 2030](http://plei2030.unal.edu.co/).

---
### Otras Fuentes institucionales de información cuantitativa 


1.	Nivel Nacional: 
Serie de Revista de Estadísticas e Indicadores de la Universidad - Dirección Nacional de Planeación y Estadística

  - Sitio Web: http://www.onp.unal.edu.co/  -  Pestaña publicaciones  - Opción revistas

2.	La sede en cifras de la Oficina de Planeación y Estadística de la Sede Bogotá

  - Sitio Web: http://planeacion.bogota.unal.edu.co/cifras.html

3.	Información estadística de la Sede Medellín provista por la Oficina de Planeación y Estadística.

  - Sitio Web: http://planeacion.medellin.unal.edu.co/ opción ESTADÍSTICA

4. Información estadística de la Sede Palmira provista por la Oficina de Planeación y Estadística.

  - Sitio Web:   http://www.palmira.unal.edu.co/index.php/lasede/gestion opción Boletines Estadísticos
...
.pull-left[
 ### [1. Programas académicos](https://estadisticaun.github.io/TendenciasPGD2018/#6)
 ### [2. Inscritos y admitidos](https://estadisticaun.github.io/TendenciasPGD2018/#13)
 ### [3. Matriculados primera vez](https://estadisticaun.github.io/TendenciasPGD2018/#29)
 ### [4. Matriculados](https://estadisticaun.github.io/TendenciasPGD2018/#33)
 ### [5. Graduados](https://estadisticaun.github.io/TendenciasPGD2018/#45)
 ### [6. Docentes de carrera](https://estadisticaun.github.io/TendenciasPGD2018/#55) 
 ]
 
 .pull-right[
 
 ### [7. Razón de estudiantes por docente](https://estadisticaun.github.io/TendenciasPGD2018/#71) 
 ### [8. Administrativos de carrera](https://estadisticaun.github.io/TendenciasPGD2018/#76) 
 ### [9. Capacidad y resultados de investigación](https://estadisticaun.github.io/TendenciasPGD2018/#87) 
 ### [10. Bienestar universitario](https://estadisticaun.github.io/TendenciasPGD2018/#104) 
 ### [11. Pruebas Saber PRO 2017](https://estadisticaun.github.io/TendenciasPGD2018/#109) 
 ### [12. Deserción en Pregrado](https://estadisticaun.github.io/TendenciasPGD2018/#135) 
]
...
---
## Fuentes de información y consideraciones metodológicas

### Fuentes de información

Información provista por la [Dirección Nacional de Planeación y Estadística](http://www.onp.unal.edu.co/) con base en la información consolidada en las direcciones nacionales de [Pregrado](http://www.pregrado.unal.edu.co/) y [Postgrado](http://www.posgrados.unal.edu.co/web/) de la Universidad.
...
Información consolidada en la [Dirección Nacional de Planeación y Estadística](http://www.onp.unal.edu.co/) con base en información suministrada por la [Dirección Nacional de Admisiones de la Universidad](http://www.admisiones.unal.edu.co/).
...
Información consolidada en la [Dirección Nacional de Planeación y Estadística](http://www.onp.unal.edu.co/) con base en información suministrada por la [Dirección Nacional de Información Académica](http://www.sia.unal.edu.co/)
...
Información consolidada en la [Dirección Nacional de Planeación y Estadística](http://www.onp.unal.edu.co/) con base en información suministrada por la [Secretaría General](http://secretaria.unal.edu.co/) de la Universidad.
...
Información consolidada en la [Dirección Nacional de Planeación y Estadística](http://www.onp.unal.edu.co/) con base en información suministrada por la [Dirección Nacional de Talento Humano](http://personal.unal.edu.co/) de la Universidad
...
Indicador consolidado en la [Dirección Nacional de Planeación y  Estadística](http://www.onp.unal.edu.co/) de la Universidad.

### Consideraciones metodológicas

  - El total de docentes hace referencia a la cantidad pura de docentes activos en cada uno de los periodos académicos. No se hizo uso del total de docentes en tiempo completo equivalente.
...
Información consolidada en la [Dirección Nacional de Planeación y Estadística](http://www.onp.unal.edu.co/) con base en información suministrada por la [Dirección Nacional de Talento](http://personal.unal.edu.co/) Humano de la Universidad
...
Información consolidada por la [Dirección Nacional de Planeación y Estadística](http://www.onp.unal.edu.co/) y la  [Vicerrectoría de Investigación](http://viceinvestigacion.unal.edu.co/index.php) de la Universidad y contenida tanto en la Revista de Estadísticas e Indicadores como en la publicación de [Capacidades de Investigación](http://investigacion.unal.edu.co/servicios/capacidades-de-investigacion/indicadores-2007-2016/)
...
Información consolidada en la [Dirección Nacional de Planeación y Estadística](http://www.onp.unal.edu.co/) con base en información suministrada por la [Dirección Nacional de Bienestar Universitario](http://www.bienestar.unal.edu.co/) de la Universidad.

### Consideraciones metodológicas

- Únicamente se presenta información de los programas del Área de Gestión y Fomento Socioeconómico
...
Información consolidada y procesada por la Dirección Nacional de Planeación y Estadística con base en información provista por el Instituto Colombiano para la Evaluación de la Educación ICFES.

#### Consideraciones metodológicas

* El análisis se realizó con base en los resultados obtenidos por los estudiantes evaluados en el año 2017.
<br/>
* El análisis se adelantó sobre las cinco [competencias genéricas](http://www.icfes.gov.co/docman/estudiantes-y-padres-de-familia/saber-pro-estudiantes-y-padres/estructura-general-del-examen/modulos-saber-pro-2018-1/modulos-primera-sesion-competencias-genericas-17/3809-guia-de-orientacion-modulos-de-competencias-genericas-saber-pro-2017/file?force-download=1) evaluadas en el Examen Saber PRO:
  + Lectura Crítica
  ...
  + Inglés 
<br/>
* Los escenarios creados para efectos de análisis son creaciones institucionales para poder analizar de una mejor manera la información disponible.
...
Información consolidada y procesada por la Dirección Nacional de Planeación y Estadística con base en información disponible en el [Sistema de Prevención y Análisis de la Deserción en las Instituciones de Educación Superior](https://www.mineducacion.gov.co/sistemasdeinformacion/1735/w3-propertyname-2895.html) SPADIES del Ministerio de Educación Nacional.

#### Consideraciones metodológicas

* <p style="font-size:63%;"> El análisis de la deserción definitiva involucra básicamente dos metodologías de abordaje: deserción por cohortes o deserción por periodo. En esta presentación se hace uso de una aproximación a la deserción por cohortes.</p>
* <p style="font-size:63%;"> Los nuevos desarrollos realizados en el SPADIES por parte del Ministerio de Educación han dificultado el reporte de información a este sistema por parte de la Universidad durante los años 2017 y 2018.</p> 
* <p style="font-size:63%;"> Para efectos de este análisis se consideraron las cohortes de matriculados por primera vez en los años 2007 y 2008 y se evaluó su comportamiento 15 semestres después (deserción acumulada al periodo 15). Así mismo, se consideraron las cohortes 2014 y 2015 y se evaluó su comportamiento al periodo 2 (deserción a primer semestre)</p>
* <p style="font-size:63%;"> Los programas académicos con una baja cobertura en matriculados por primera vez pueden presentar importantes variaciones en las cifras presentadas.</p>
* <p style="font-size:63%;"> Por lo anterior, este análisis es una aproximación al comportamiento de este fenómeno en la institución el cual invita a los interesados a indagar y profundizar en los diferentes aspectos de esta problemática tanto a nivel global como local, previo a la extracción de conclusiones.</p>
